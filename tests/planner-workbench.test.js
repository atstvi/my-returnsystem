...
t.ok('returnTriageRemain: 미처리 합(마감 제외)', /function returnTriageRemain\(\)\{[\s\S]*?return inbox\+unlinked\+unsched\+overdue;/.test(html));
...
t.ok('완료 판정 remain===0', /var doneAll=\(remain===0\);/.test(html) && /remain=inbox\.length\+unlinked\.length\+unsched\.length\+overdue\.length;/.test(html));
