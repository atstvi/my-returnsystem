...
(async () => {
  ...
  await new Promise((res) => {
    const it = { url: 'https://x.com', _titleEdited: false, _metaLoading: true };
    sb.boardEnrichItem(it, (ok) => {
      ...
      t.ok('enrich: clears loading + ok true', it._metaLoading === false && ok === true, 'loading=' + it._metaLoading + ' ok=' + ok);
      res();
    });
  });
  ...
  await new Promise((res) => {
    const it = { url: 'https://x.com', _titleEdited: false, _metaLoading: true };
    sb.boardEnrichItem(it, (ok) => { t.ok('enrich: failure clears loading, ok false', it._metaLoading === false && ok === false, 'loading=' + it._metaLoading + ' ok=' + ok); res(); });
  });
